...
int ios_system(const char* inputCmd) {
    ...
    if (argc != 0) {
        ...
        if (commandStructure != nil) {
            ...
            // Perl and TeX can have multiple commands calling themselves:
            // hasPrefix covers perl, perl5, etc.
            // NOTE: the python multi-interpreter block was removed here on
            // purpose — Scripting runs a single embedded Python and intercepts
            // python/python3/pip in the Swift layer before they reach this
            // dispatch, so the per-interpreter slotting / "too many python
            // scripts" handling is dead weight in this fork.
